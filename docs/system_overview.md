...
| `runtime.apply.*` | apply adapter | `tofu_binary_missing`, `ansible_binary_missing`, `ssh_binary_missing`, `wait_ssh_timeout`, `wait_cloud_init_timeout`, `wait_cloud_init_failed`, `wait_unexpected`, `verify_failed`, `verify_ssh_missing` |
